...
function onSignIn(googleUser) {
  ...
  //sendName();
  document.getElementById('ownimage').innerHTML =
...
function check(x, y, value, color) {
  ...
  if (value == 3) {
    if (x == 0 || x == 8 || y == 0 || y == 5) brkblk(x, y, color)
  }
  if (value == 4) {
    brkblk(x, y, color)
  }
  ...
  if (num[x][y] == 1) {
    if (
      ...
      document.getElementById(pt).innerHTML =
        ...
        color +
        'Single.png' +
        " width=45px height=45px class='ballrotate'/>"
    } else {
      document.getElementById(pt).innerHTML =
        '<img src=/images/' + color + 'Single.png' + ' width=45px height=45px/>'
    }
  ...
  if (num[x][y] == 2) {
    if (x == 0 || y == 0 || x == 8 || y == 5) {
      ...
      document.getElementById(pt).innerHTML =
        ...
        color +
        'Double.png' +
        " width=45px height=45px class='ballslowrotate'/>"
    }
    colorarray[x][y] = color
  }
  if (num[x][y] == 3) {
...
function setupChat() {
  ...
  write('       developed by Dhwani Singh        ')
  write('                  19/07/2023            ')
  ...
  ws.addEventListener(
    ...
    function () {
      ...
      preloadimages([
        '/images/redSingle.png',
        '/images/greenSingle.png',
        '/images/redDouble.png',
        '/images/greenDouble.png',
        '/images/redTriple.png',
        '/images/greenTriple.png',
      ])
    },
    false,
  )
...
function checkWin() {
  ...
  for (i = 0; i < 9; i++)
    for (j = 0; j < 6; j++) {
      if (num[i][j] != 0) a++
      if (colorarray[i][j] == player[0][1]) b++
      else if (colorarray[i][j] == player[1][1]) c++
    }
  if (a == b && a >= 2) {
